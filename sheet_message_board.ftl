...
<html lang="zh-CN">
  ...
  <body>
    <div id="Joe">
      ...
      <div class="message_board_container joe_container joe_main_container page-sheet${(settings.aside_position=='left')?then(' revert','')}">
        <div class="joe_main">
            ...
            <#else>
              <div class="joe_comment">
                <div class="joe_comment__close">
                  ...
                  <span>${(sheet.status=='DRAFT')?then('预览状态下不可留言','博主关闭了留言功能哦')}</span>
                </div>
              </div>
            </#if>
          </div>
