...
<#global BASE_RES_URL = (mode == "production" && settings.enable_cdn == true)?string("https://cdn.staticaly.com/gh/qiushaocloud/halo-theme-joe2.0-qiu@" + theme.version, theme_base)>
<#--  <#global BASE_RES_URL = (mode == "production" && settings.enable_cdn == true)?string("https://cdn.staticaly.com/gh/qiushaocloud/halo-theme-joe2.0-qiu@master", theme_base)>  -->
<#--  <#global BASE_RES_URL = (mode == "production" && settings.enable_cdn == true)?string("https://cdn.staticaly.com/gh/qiushaocloud/halo-theme-joe2.0-qiu@dev", theme_base)>  -->
