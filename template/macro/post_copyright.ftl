  ...
  <div class="joe_detail__copyright">
    <div class="content">
      ...
      <div class="item">
        ...
        <#else>
          本文使用《<a class="link" href="//creativecommons.org/licenses/by-nc-sa/4.0/deed.zh" target="_blank" rel="noopener noreferrer nofollow">署名-非商业性使用-相同方式共享 4.0 国际 (CC BY-NC-SA 4.0)</a>》协议授权，转载前请务必署名
        </#if>
        </span>
      </div>
    </div>
