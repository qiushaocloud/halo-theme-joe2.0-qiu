    ...
    <div id="Joe">
      ...
      <div class="joe_container joe_main_container page-post${(settings.aside_position=='left')?then(' revert','')}">
        <div class="joe_main joe_post">
          ...
          <div class="joe_detail" data-status="${post.status!}" data-cid="${post.id}" data-clikes="${post.likes}" data-author="${user.nickname!}">
                ...
                <#if settings.enable_passage_tips>
                  <div class="joe_detail__overdue-wrapper">
                    ...
                    <div class="content">
                      ...
                      <#else>
                        本文最后更新于 ${post.updateTime?string('yyyy-MM-dd')}，若内容或图片失效，请留言反馈。部分素材来自网络，若不小心影响到您的利益，请联系博主删除。
                      </#if>
                    </div>
                  </div>
                </#if>
