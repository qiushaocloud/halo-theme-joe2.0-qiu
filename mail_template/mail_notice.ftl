<div class="email-page" style="background:#fff;">
  <#--  <link rel="stylesheet" href="https://originfastly.jsdelivr.net/gh/qiushaocloud/halo-theme-joe2.0-qiu@master/source/css/min/joe.emoji.min.css">  -->
  ...
  <#--  <script src="https://originfastly.jsdelivr.net/gh/qiushaocloud/halo-theme-joe2.0-qiu@master/source/lib/j-marked/marked.min.js"></script>
  <script src="https://originfastly.jsdelivr.net/gh/qiushaocloud/halo-theme-joe2.0-qiu@master/source/js/min/joe.utils.min.js"></script>
  <script>
    /* 渲染内容中的 emoji */
